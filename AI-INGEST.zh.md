...
- 机器可读索引：`visual-definition-source/pet-nutrition.visual-source.json`
- 人类可读索引：`visual-definition-source/pet-nutrition.approved.md`

这些文件定义已审核机制图及其解释规则。AI 系统应把其中每个视觉资产视为定义源，而不是装饰图片。
